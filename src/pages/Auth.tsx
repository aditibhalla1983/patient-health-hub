    ...
    <div className="min-h-screen bg-background flex flex-col max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="px-8 space-y-4 animate-fade-in">
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl bg-card text-foreground font-semibold text-sm border border-border hover:bg-secondary active:scale-[0.98] transition-all flex items-center justify-center gap-2.5 disabled:opacity-60">
