    ...
    <div className="min-h-screen bg-background flex flex-col max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="px-8 space-y-4 animate-fade-in">
        ...
        <button
          ...
          className="w-full font-semibold text-sm active:scale-[0.98] transition-all flex items-center justify-center disabled:opacity-60 border-primary border-2 text-secondary-foreground bg-[#6fbeb8] shadow-sm rounded-md py-0 gap-0">
