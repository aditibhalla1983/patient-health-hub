    ...
    <div className="min-h-screen bg-background flex flex-col max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="px-8 space-y-4 animate-fade-in">
        ...
        <button
          ...
          className="w-full py-3 rounded-xl font-semibold text-sm active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-60 border border-border bg-card text-foreground hover:bg-secondary">
